    ...
    return declare([BaseWidget], {
      ...
      _loadCounters: function() {
        var config = {
          ...
          charsImageUrl: "widgets/AdvancedSummary/images/c.png",
          markerImageUrl: "widgets/AdvancedSummary/images/m.png"
        };
      ...
      // summarize
      _summarize: function() {
		console.debug("running the advanced summary"); 
        if (this.sumTimer) {
